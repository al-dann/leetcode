...
# Runtime: 76 ms, faster than 92.95% of Python3 online submissions
# Memory Usage: 15.8 MB, less than 95.64% of Python3 online submissions

if __name__ == '__main__':
    my_solution = Solution()
    in_lst = [0, 0, 1, 1, 1, 2, 2, 3, 3, 4, 4]
    # in_lst = [0, 0, 1]
    # in_lst = []
    print("input: {}".format(in_lst))
    print("result: {}".format(my_solution.remove_duplicates(in_lst)))
