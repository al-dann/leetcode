...
return 2 with nums = [2,2,3,3] or nums = [2,2,0,0], your answer will be accepted.
...
# Runtime: 36 ms, faster than 50.33% of Python3 online submissions for Remove Element.
...
if __name__ == '__main__':
    ...
    print("result: {}".format(my_solution.remove_element(in_lst, rm_val)))
